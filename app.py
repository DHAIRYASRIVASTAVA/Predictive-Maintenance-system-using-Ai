...
def get_risk_and_recommendation(status: str, failure_prob: float):
    ...
    # escalate risk if probability is very high regardless of class edge cases
...
if page == "Predict":
    ...
    if not ARTIFACTS_OK:
        ...
        if submitted:
            ...
            # "failure probability" = P(Warning) + P(Faulty)
            failure_prob = round(
...
# PAGE: Dashboard
    ...
    if history_df.empty:
        ...
        st.markdown("#### Sensor Correlation with Risk")
